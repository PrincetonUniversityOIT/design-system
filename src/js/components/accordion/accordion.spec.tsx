...
it('We can check that content is hidden and shown correctly', () => {
    document.body.innerHTML = `
      <div class="emc-accordion" role="region">
          <h2>
            <button id="acrd-btn-1" class="emc-accordion__button" aria-controls="content1">Sed porttitor lectus nibh?</button>
          </h2>
          <div class="emc-accordion__content" id="content1">
              Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Praesent sapien massa, convallis a 
              pellentesque nec, egestas non nisi.
          </div>
          <h2>
            <button id="acrd-btn-2" class="emc-accordion__button" aria-expanded="true" aria-controls="content2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ultricies ligula sed magna dictum porta?</button>
          </h2>
          <div aria-hidden="false" class="emc-accordion__content" id="content2">
          ...
          <h2>
            <button class="emc-accordion__button" aria-controls="content3">Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus. Curabitur aliquet quam id dui posuere blandit.</button>
          </h2>
          <div class="emc-accordion__content" id="content3">
          ...
          <h2>
            <button class="emc-accordion__button" aria-controls="content4">Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus. Curabitur aliquet quam id dui posuere blandit.</button>
          </h2>
          <div class="emc-accordion__content" id="content4">
              Nulla porttitor accumsan tincidunt. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices 
              posuere cubilia Curae; Donec velit neque, auctor sit amet aliquam vel, ullamcorper sit amet ligula. 
              Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem.
          </div>
...
it('We can check that content is hidden and shown correctly for multi selectable accordions', () => {
    document.body.innerHTML = `
      <div id="accordion1" class="emc-accordion" role="region" aria-multiselectable="true">
          <h2>
            <button id="acrd-btn-1" class="emc-accordion__button" aria-controls="content1">Sed porttitor lectus nibh?</button>
          </h2>
          <div class="emc-accordion__content" id="content1">
          ...
          <h2>
            <button id="acrd-btn-2" class="emc-accordion__button" aria-controls="content2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ultricies ligula sed magna dictum porta?</button>
          </h2>
          <div aria-hidden="false" class="emc-accordion__content" id="content2">
              Quisque velit nisi, pretium ut lacinia in, elementum id enim. Curabitur arcu erat, accumsan id imperdiet 
              et, porttitor at sem. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. 
...
it('We can check that content is hidden and shown correctly for non-multi selectable accordions', () => {
  document.body.innerHTML = `
      <div id="accordion1" class="emc-accordion" role="region">
          <h2>
            <button id="acrd-btn-1" class="emc-accordion__button" aria-controls="content1">Sed porttitor lectus nibh?</button>
          </h2>
          <div class="emc-accordion__content" id="content1">
