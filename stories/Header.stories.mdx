...
export const TemplateComponent = (args) => html`
    <header role="banner" class="emc-header">
        ...
        <!-- div class="emc-container" -->
            ...
            <div class="emc-header__search-bar">
                ...
                <button class="emc-header__search-bar-toggle" aria-expanded="false" aria-label="Search Menu Toggle"><i class="emc-icon emc-icon-search" aria-hidden="true"></i><span class="emc-sr-only">Search Menu Toggle</span></button>
                <div class="emc-header__search-bar-panel">
