    ...
    <header role="banner" class="pjz-header">
        ...
        <!-- div class="pjz-container" -->
                    ...
                    <div class="pjz-menu__nav-container">
                        <ul class="pjz-menubar" role="list">
                            <li aria-current="true">
                                ...
                                <button class="pjz-menu__submenu-toggle" type="button" aria-expanded="${ args.forceExpanded }">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <button type="button" class="pjz-menu__submenu-toggle" aria-expanded="${ args.forceExpanded }">
                                            <span class="pjz-sr-only">
                                                Page
                                                SubMenu
                                            </span>
            ...
            <div class="pjz-header__search-bar">
                ...
                <button id="my-search-toggle" class="pjz-header__search-bar-toggle" aria-expanded="false" aria-label="Search Menu Toggle"><i class="pjz-icon pjz-icon-search" aria-hidden="true"></i><span class="pjz-sr-only">Search Menu Toggle</span></button>
                <div id="pjz-header-search-bar-panel" class="pjz-header__search-bar-panel">
