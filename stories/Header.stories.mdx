        ...
        <!-- div class="emc-container" -->
            ...
            <nav aria-label="Main Menu" class="emc-header__main-menu">
                ...
                <div class="emc-header__main-menu-navbar">
                    <button class="emc-header__menu-toggle" aria-expanded="false" aria-label="Navigation Menu Toggle">Menu<i class="emc-icon emc-icon-menu" aria-hidden="true"></i></button>
                    <div class="emc-header__nav-container">
                        <ul class="emc-menubar" role="list">
                            <li aria-current="true">
                                <a href="javascript:void(0);" aria-current="page">Content Types</a>
                                <button class="emc-header__submenu-toggle" type="button" aria-expanded="${ args.forceExpanded }">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <button type="button" class="emc-header__submenu-toggle" aria-expanded="${ args.forceExpanded }">
                                            <span class="emc-sr-only">
                                                Page
                                                SubMenu
                                            </span>
                            ...
                            <li>
                                ...
                                <button type="button" class="emc-header__submenu-toggle" aria-expanded="false">
                                    <span class="emc-sr-only">
                                        Blocks
                                        SubMenu
                                    </span>
                            ...
                            <li>
                                ...
                                <button class="emc-header__submenu-toggle" type="button" aria-expanded="false">
                                    <span class="emc-sr-only">
                                        Images &amp; Media
                                        SubMenu
                                    </span>
