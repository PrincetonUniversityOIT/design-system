...
export const Template = (args) => html`
    <nav aria-label="Main Menu" class="pjz-menu pjz-menu__main-menu">
        ...
        <div class="pjz-menu__main-menu-navbar">
            <button class="pjz-menu__menu-toggle" aria-expanded="false" aria-label="Navigation Menu Toggle">Menu<i class="pjz-icon pjz-icon-menu" aria-hidden="true"></i></button>
