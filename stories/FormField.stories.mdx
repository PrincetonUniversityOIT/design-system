...
export const Template = (args) => html`
    ...
    <div class="jazz-form-field">
        <label for="my-input5">${ args.label }<span class="jazz-form-field-required" aria-hidden="true">*</span></label>
        <input class="jazz-input" id="my-input5" type="text" placeholder="Placeholder" required value="${ args.value }" required />
    </div>
`;
