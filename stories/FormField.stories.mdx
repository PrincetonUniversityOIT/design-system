...
export const Template = (args) => html`
    ...
    <div class="jazz-form-field">
        <label for="my-input" required>${ args.label } - Required</label>
        <input class="jazz-input" id="my-input" type="text" placeholder="Placeholder" value="${ args.value }" />
    </div>
    <div class="jazz-form-field" disabled>
        <label for="my-input5">${ args.label } - Disabled</label>
        <input class="jazz-input" id="my-input5" type="text" placeholder="Placeholder" disabled value="${ args.value }" />
    </div>
    <div class="jazz-form-field">
    ...
    <div class="jazz-form-field--error">
        ...
        <span class="jazz-form-field-msg" id="my-input4-msg">Provide a helpful hint about the field</span>
        <input class="jazz-input jazz-input--error" id="my-input3" type="text" placeholder="Placeholder" value="${ args.value }" aria-describedby="my-input3-msg" />
        <span class="jazz-form-field-error-msg" id="my-input3-msg" role="alert">Clear and brief error message</span>
    </div>
    <div class="jazz-form-field">
        <label for="my-input4">${ args.label } - With Hint</label>
        <span class="jazz-form-field-msg" id="my-input4-msg">Provide a helpful hint about the field</span>
        <input class="jazz-input" id="my-input4" type="text" placeholder="Placeholder" required value="${ args.value }" aria-describedby="my-input4-msg" />
    </div>
`;
