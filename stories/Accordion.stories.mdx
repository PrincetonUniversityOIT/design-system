...
export const BorderedTemplate = (args) => html`
      <div class="jazz-accordion jazz-accordion--bordered" role="region">
          ...
          <h2>
            <button id="acrd-btn-2" class="jazz-accordion__button expanded" aria-expanded="true" aria-controls="content2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ultricies ligula sed magna dictum porta?</button>
          </h2>
