...
export const Template = (args) => html`
    <ul class="jazz-menubar jazz-menubar--shown" role="list">
        <li aria-current="true">
            ...
            <ul>
                <li>
                    ...
                    <ul class="jazz-menubar__submenu--shown">
...
export const SingleMenuTemplate = (args) => html`
    <ul class="jazz-menubar" role="list">
        <li aria-current="true">
            <a href="javascript:void(0);" aria-current="page">Section 1</a>
        </li>
        <li>
...
<Canvas>
    <Story name="Basic Single Menu" args={{
        forceExpanded: false
    }}>
      {SingleMenuTemplate.bind({})}
    </Story>
</Canvas>
